...
namespace BlogProject.BLL.Describers
{
    public class CustomIdentityErrorDescriber : IdentityErrorDescriber
    {
        ...
        {
            return new IdentityError { Code = "PasswordRequiresUniqueChars", Description = $"En az {uniqueChars} kadar farklı karakter içermelidir." };
        }
    }
}
